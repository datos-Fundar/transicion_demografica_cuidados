...
Código para armar la base de intensidad de demanda de cuidados en Argentina, en función de bases de datos del Censo 2022, proyecciones poblacionales del Censo 2010
...
Usamos las bases de Estructura por sexo y edad del Censo 2022 de INDEC. Total de población, por sexo registrado al nacer e índice de feminidad, según edad y departamento. Año 2022 [https://www.indec.gob.ar/indec/web/Nivel4-Tema-2-41-165] 

```{r limpieza base}
base_proyecciones <- read_excel("./base_proyecciones.xlsx") %>% 
  select(c(2,3,10,11,12))

base_compilada <- read_excel("./base_compilada.xlsx")
